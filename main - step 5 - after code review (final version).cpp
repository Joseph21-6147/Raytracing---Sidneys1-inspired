...
// Article and code by Sidneys1.com)
// url: https://sidneys1.com/programming/2022/03/23/raytracing.html

// Implementation by Joseph21, 20220804
// got upto: final version
...
public:
    bool OnUserCreate() override {
        ...
        // add a "floor" Plane
        shapes.emplace_back( std::make_unique<Plane>(vf3d( 0, 200, 0 ), vf3d( 0, -1, 0 ), LIGHT_GREY, DARK_GREY ));
